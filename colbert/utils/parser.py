...
class Arguments():
    ...
    def add_model_parameters(self):
        ...
        self.add_argument('--linear_layer', dest='linear_layer', default='original', choices=['original', 'none', 'static_mapping', 'trained_mapping', 'static_random'])
        self.add_argument('--aggregation', dest='aggregation', default='none', choices=['none', 'first', 'last', 'avg'])
        self.add_argument('--replication', dest='replication', default='replicate', choices=['replicate', 'pad'])
    ...
    def parse(self):
        ...
        args.nthreads = int(os.cpu_count())
