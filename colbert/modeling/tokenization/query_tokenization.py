...
class QueryTokenizer():
    ...
    def tensorize(self, batch_text, bsize=None):
        ...
        obj = self.tok(batch_text, padding='max_length', truncation=True, is_split_into_words=True,
                       return_tensors='pt', max_length=self.query_maxlen, return_offsets_mapping=True)
